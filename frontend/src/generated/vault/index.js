...
class _Either_0 {
  alignment() {
    return _descriptor_7.alignment().concat(_descriptor_5.alignment().concat(_descriptor_8.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_7.toValue(value_0.is_left).concat(_descriptor_5.toValue(value_0.left).concat(_descriptor_8.toValue(value_0.right)));
  }
}
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_11.alignment().concat(_descriptor_6.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_11.toValue(value_0.domain_sep).concat(_descriptor_6.toValue(value_0.info).concat(_descriptor_7.toValue(value_0.dataType).concat(_descriptor_1.toValue(value_0.data))));
  }
}
...
class _Maybe_0 {
  ...
  toValue(value_0) {
    return _descriptor_7.toValue(value_0.is_some).concat(_descriptor_6.toValue(value_0.value));
  }
}
...
class _ShieldedSendResult_0 {
  ...
  toValue(value_0) {
    return _descriptor_14.toValue(value_0.change).concat(_descriptor_6.toValue(value_0.sent));
  }
}
...
export class Contract {
  ...
  _withdraw_0(context, partialProofData, coin_0, to_0, amount_0) {
