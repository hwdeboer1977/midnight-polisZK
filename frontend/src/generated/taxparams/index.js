...
export class Contract {
    ...
    this.circuits = {
      transferAuthority: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(newAuthority_0),
      ...
      publish: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(params_0),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(0n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(newAuthority_0),
                                                                                              alignment: _descriptor_5.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _publish_0(context, partialProofData, params_0) {
    ...
    let t_1;
    const r12_0 = (t_1 = params_0.rate1, t_1 > params_0.rate2) ?
                  params_0.rate1 :
                  params_0.rate2;
    const rateMax_0 = r12_0 > params_0.rate3 ? r12_0 : params_0.rate3;
    let t_2;
    __compactRuntime.assert((t_2 = rateMax_0 + params_0.contribRate,
                             t_2 <= 10000n),
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(v_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(params_0),
