...
export class Contract {
  ...
  _mintTo_0(context, partialProofData, amount_0, recipient_0) {
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('peur.compact line 86 char 17: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(next_0);
    __compactRuntime.queryLedgerState(context,
  ...
  _mint_0(context, partialProofData, amount_0) {
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('peur.compact line 115 char 17: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(next_0);
    __compactRuntime.queryLedgerState(context,
