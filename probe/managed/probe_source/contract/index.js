...
class _Either_0 {
  alignment() {
    return _descriptor_6.alignment().concat(_descriptor_7.alignment().concat(_descriptor_5.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_6.toValue(value_0.is_left).concat(_descriptor_7.toValue(value_0.left).concat(_descriptor_5.toValue(value_0.right)));
  }
}
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_12.alignment().concat(_descriptor_8.alignment().concat(_descriptor_6.alignment().concat(_descriptor_1.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_12.toValue(value_0.domain_sep).concat(_descriptor_8.toValue(value_0.info).concat(_descriptor_6.toValue(value_0.dataType).concat(_descriptor_1.toValue(value_0.data))));
  }
}
...
class _Maybe_0 {
  ...
  toValue(value_0) {
    return _descriptor_6.toValue(value_0.is_some).concat(_descriptor_8.toValue(value_0.value));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      setVault: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`setVault: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const target_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('setVault',
                                     'argument 1 (as invoked from Typescript)',
                                     'probe_source.compact line 25 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(target_0) === 'object' && target_0.bytes.buffer instanceof ArrayBuffer && target_0.bytes.BYTES_PER_ELEMENT === 1 && target_0.bytes.length === 32)) {
          __compactRuntime.typeError('setVault',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(target_0),
        ...
        const result_0 = this._setVault_0(context, partialProofData, target_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      sendToUser: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`sendToUser: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('sendToUser',
                                     'argument 1 (as invoked from Typescript)',
                                     'probe_source.compact line 33 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(coin_0).concat(_descriptor_7.toValue(to_0).concat(_descriptor_2.toValue(amount_0))),
            alignment: _descriptor_4.alignment().concat(_descriptor_7.alignment().concat(_descriptor_2.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      sendToContract: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`sendToContract: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const coin_0 = args_1[1];
        const to_0 = args_1[2];
        const amount_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('sendToContract',
                                     'argument 1 (as invoked from Typescript)',
                                     'probe_source.compact line 47 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(coin_0) === 'object' && coin_0.nonce.buffer instanceof ArrayBuffer && coin_0.nonce.BYTES_PER_ELEMENT === 1 && coin_0.nonce.length === 32 && coin_0.color.buffer instanceof ArrayBuffer && coin_0.color.BYTES_PER_ELEMENT === 1 && coin_0.color.length === 32 && typeof(coin_0.value) === 'bigint' && coin_0.value >= 0n && coin_0.value <= 340282366920938463463374607431768211455n && typeof(coin_0.mt_index) === 'bigint' && coin_0.mt_index >= 0n && coin_0.mt_index <= 18446744073709551615n)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(coin_0).concat(_descriptor_5.toValue(to_0).concat(_descriptor_2.toValue(amount_0))),
            alignment: _descriptor_4.alignment().concat(_descriptor_5.alignment().concat(_descriptor_2.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
        };
        const result_0 = this._sendToContract_0(context,
                                                partialProofData,
                                                coin_0,
                                                to_0,
                                                amount_0);
      ...
      sendToStoredVault: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`sendToStoredVault: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const coin_0 = args_1[1];
        const amount_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('sendToStoredVault',
                                     'argument 1 (as invoked from Typescript)',
                                     'probe_source.compact line 62 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(coin_0) === 'object' && coin_0.nonce.buffer instanceof ArrayBuffer && coin_0.nonce.BYTES_PER_ELEMENT === 1 && coin_0.nonce.length === 32 && coin_0.color.buffer instanceof ArrayBuffer && coin_0.color.BYTES_PER_ELEMENT === 1 && coin_0.color.length === 32 && typeof(coin_0.value) === 'bigint' && coin_0.value >= 0n && coin_0.value <= 340282366920938463463374607431768211455n && typeof(coin_0.mt_index) === 'bigint' && coin_0.mt_index >= 0n && coin_0.mt_index <= 18446744073709551615n)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(coin_0).concat(_descriptor_2.toValue(amount_0)),
        ...
        const result_0 = this._sendToStoredVault_0(context,
                                                   partialProofData,
                                                   coin_0,
                                                   amount_0);
        partialProofData.output = { value: [], alignment: [] };
    ...
    this.impureCircuits = {
      setVault: this.circuits.setVault,
      sendToUser: this.circuits.sendToUser,
      sendToContract: this.circuits.sendToContract,
      sendToStoredVault: this.circuits.sendToStoredVault
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('setVault', new __compactRuntime.ContractOperation());
    state_0.setOperation('sendToUser', new __compactRuntime.ContractOperation());
    state_0.setOperation('sendToContract', new __compactRuntime.ContractOperation());
    state_0.setOperation('sendToStoredVault', new __compactRuntime.ContractOperation());
  ...
  _setVault_0(context, partialProofData, target_0) {
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_17.toValue(2n),
                                                                                              alignment: _descriptor_17.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(target_0),
                                                                                              alignment: _descriptor_5.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _sendToUser_0(context, partialProofData, coin_0, to_0, amount_0) {
  ...
  _sendToContract_0(context, partialProofData, coin_0, to_0, amount_0) {
    this._sendShielded_0(context,
                         partialProofData,
                         coin_0,
                         this._right_0(to_0),
  ...
  _sendToStoredVault_0(context, partialProofData, coin_0, amount_0) {
    __compactRuntime.assert(_descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
